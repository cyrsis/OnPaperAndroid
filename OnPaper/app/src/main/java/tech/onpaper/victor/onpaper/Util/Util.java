package tech.onpaper.victor.onpaper.Util;
...
public class Util {
    ...
    public static final String URL_STORAGE_REFERENCE = "gs://onpaper-9c248.appspot.com";
    ...
    public  static boolean verificaConexao(Context context) {
        boolean conectado;
        ConnectivityManager
            conectivtyManager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
