package tech.getonpaper.victor.onpaper.adapter;
...
import tech.getonpaper.victor.onpaper.R;
import tech.getonpaper.victor.onpaper.model.ChatModel;
...
public class ChatFirebaseAdapter
    ...
    protected void populateViewHolder(MyChatViewHolder viewHolder, ChatModel model, int position) {
        ...
        if (model.getFile() != null){
            ...
            viewHolder.setIvChatPhoto(tech.getonpaper.victor.onpaper.util.Util.local(model.getMapModel().getLatitude(),model.getMapModel().getLongitude()));
